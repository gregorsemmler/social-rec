...
/**
 * Tests a {@link MSuccessAtN} metric
 */
@CompileStatic
class MSuccessAtNTest extends GroovyAssert {
    ...
    @Test
    void testEvaluate() {
        MSuccessAtN metric = new MSuccessAtN()
        metric.N = 3
        metric.M = 2
    ...
    void testIsSuccess() {
        ...
        boolean result = metric.isSuccess(baselineRatings, evaluateRatings)
