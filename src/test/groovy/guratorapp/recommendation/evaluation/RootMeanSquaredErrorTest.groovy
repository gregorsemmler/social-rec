...
/**
 * Tests a {@link RootMeanSquaredError} metric
 */
@CompileStatic
class RootMeanSquaredErrorTest extends GroovyAssert {
    ...
    @Test
    void testEvaluate() {
        RootMeanSquaredError metric = new RootMeanSquaredError()

        double result = metric.evaluate(baselineRatings, evaluateRatings)
        Assert.assertEquals(1.8708286933869707, result, DELTA)
    }
