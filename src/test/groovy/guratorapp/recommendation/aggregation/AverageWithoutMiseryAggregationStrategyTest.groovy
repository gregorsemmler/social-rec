...
/**
 * Tests an {@link guratorapp.recommendation.aggregation.AverageWithoutMiseryAggregationStrategy}
 */
@CompileStatic
class AverageWithoutMiseryAggregationStrategyTest extends GroovyAssert{
    ...
    void testAggregateRatings() {
        AverageWithoutMiseryAggregationStrategy strategy = new AverageWithoutMiseryAggregationStrategy()
        strategy.miseryThreshold = 5.0 as double
        ...
        Assert.assertEquals(5.666666666666666 , result[5].score, DELTA)
        Assert.assertEquals(-1.0 , result[6].score, DELTA)
        Assert.assertEquals(-1.0 , result[7].score, DELTA)
        Assert.assertEquals(-1.0 , result[8].score, DELTA)
