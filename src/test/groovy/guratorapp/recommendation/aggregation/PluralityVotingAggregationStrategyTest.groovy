...
/**
 * Tests an {@link guratorapp.recommendation.aggregation.PluralityVotingAggregationStrategy}
 */
@CompileStatic
class PluralityVotingAggregationStrategyTest extends GroovyAssert{
    ...
    void testAggregateRatings() {
        PluralityVotingAggregationStrategy strategy = new PluralityVotingAggregationStrategy()

        Collection<GroupRestaurantRating> result = strategy.aggregateRatings(restaurants, testgroup)

        Assert.assertEquals(10, result.size())

        Assert.assertEquals(1 as long, result[0].restaurantId)
        Assert.assertEquals(5 as long, result[1].restaurantId)
        Assert.assertEquals(6 as long, result[2].restaurantId)
        Assert.assertEquals(4 as long, result[3].restaurantId)
        Assert.assertEquals(9 as long, result[4].restaurantId)
        Assert.assertEquals(8 as long, result[5].restaurantId)
        Assert.assertEquals(10 as long, result[6].restaurantId)
        Assert.assertEquals(2 as long, result[7].restaurantId)
        Assert.assertEquals(7 as long, result[8].restaurantId)
        Assert.assertEquals(3 as long, result[9].restaurantId)

        Assert.assertEquals(10.0 , result[0].score, DELTA)
        Assert.assertEquals(9.0 , result[1].score, DELTA)
        Assert.assertEquals(8.0 , result[2].score, DELTA)
        Assert.assertEquals(7.0 , result[3].score, DELTA)
        Assert.assertEquals(6.0 , result[4].score, DELTA)
        Assert.assertEquals(5.0 , result[5].score, DELTA)
        Assert.assertEquals(4.0 , result[6].score, DELTA)
        Assert.assertEquals(3.0 , result[7].score, DELTA)
        Assert.assertEquals(2.0 , result[8].score, DELTA)
        Assert.assertEquals(1.0 , result[9].score, DELTA)
    }
    ...
    void testDifferentGroup() {
        ...
        Assert.assertEquals(9 as long, result[0].restaurantId)
        Assert.assertEquals(2 as long, result[1].restaurantId)
        Assert.assertEquals(3 as long, result[2].restaurantId)
        Assert.assertEquals(4 as long, result[3].restaurantId)
        Assert.assertEquals(6 as long, result[4].restaurantId)
        Assert.assertEquals(7 as long, result[5].restaurantId)
        Assert.assertEquals(10 as long, result[6].restaurantId)
        Assert.assertEquals(8 as long, result[7].restaurantId)
        Assert.assertEquals(1 as long, result[8].restaurantId)
        Assert.assertEquals(5 as long, result[9].restaurantId)
    }
}