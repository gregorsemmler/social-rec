...
/**
 * Tests an {@link guratorapp.recommendation.aggregation.BordaCountAggregationStrategy}
 */
@CompileStatic
class BordaCountAggregationStrategyTest extends GroovyAssert{
    ...
    void testAggregateRatings() {
        BordaCountAggregationStrategy strategy = new BordaCountAggregationStrategy()
        ...
        Assert.assertEquals(1 as long, result[2].restaurantId)

        Assert.assertTrue(result[3].restaurantId == 8 || result[3].restaurantId == 4)
        Assert.assertTrue(result[4].restaurantId == 8 || result[4].restaurantId == 4)
        ...
        Assert.assertEquals(12.333333333333332 , result[0].score, DELTA)
        Assert.assertEquals(12.25 , result[1].score, DELTA)
        Assert.assertEquals(10.333333333333332 , result[2].score, DELTA)
        Assert.assertEquals(8.25 , result[3].score, DELTA)
        Assert.assertEquals(8.25 , result[4].score, DELTA)
        Assert.assertEquals(7.833333333333333 , result[5].score, DELTA)
        Assert.assertEquals(7.5 , result[6].score, DELTA)
        Assert.assertEquals(5.75 , result[7].score, DELTA)
        Assert.assertEquals(4.0 , result[8].score, DELTA)
        Assert.assertEquals(3.5 , result[9].score, DELTA)
    }
}
