...
/**
 * Tests an {@link AverageAggregationStrategy}
 */
@CompileStatic
class AverageAggregationStrategyTest extends GroovyAssert{
    ...
    void testAggregateRatings() {
        Collection<GroupRestaurantRating> result = new AverageAggregationStrategy().aggregateRatings(restaurants, testgroup)

        Assert.assertEquals(10, result.size())

        Assert.assertEquals(5 as long, result[0].restaurantId)
        Assert.assertEquals(6 as long, result[1].restaurantId)
        Assert.assertEquals(8 as long, result[2].restaurantId)
        Assert.assertEquals(4 as long, result[3].restaurantId)
        Assert.assertEquals(10 as long, result[4].restaurantId)
        Assert.assertEquals(1 as long, result[5].restaurantId)
        Assert.assertEquals(9 as long, result[6].restaurantId)
        ...
        Assert.assertEquals(8.666666666666666 , result[0].score, DELTA)
        Assert.assertEquals(8.666666666666666 , result[1].score, DELTA)
        Assert.assertEquals(7.666666666666667 , result[2].score, DELTA)
        Assert.assertEquals(7.333333333333333 , result[3].score, DELTA)
        Assert.assertEquals(7.333333333333333 , result[4].score, DELTA)
        Assert.assertEquals(7.0 , result[5].score, DELTA)
        Assert.assertEquals(6.666666666666666 , result[6].score, DELTA)
        Assert.assertEquals(6.0 , result[7].score, DELTA)
        Assert.assertEquals(5.666666666666666 , result[8].score, DELTA)
        Assert.assertEquals(4.333333333333333 , result[9].score, DELTA)
    }
}
